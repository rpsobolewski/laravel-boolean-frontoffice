...
export default {
    ...
    methods: {
        async getCocktail(id) {
            const response = await axios.get(this.fullUrl + id).then(resp => {
                return resp
            })
    ...
    mounted() {
        this.getCocktail(this.$route.params.id)
    }
}
                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-6 d-flex align-items-center">
                        <div class="card-body">
                            ...
                            <p style="color: darkorange;" class="card-text"><span v-if="!cocktail.strAlcoholic">not
                                </span>alcholic
                            </p>
